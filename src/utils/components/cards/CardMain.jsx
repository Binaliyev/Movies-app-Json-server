...
export const CardMain = ({ whileHover, whileFocus, whileTap, initial, whileInView, transition, animate, whileDrag, img, color, width, height, padding, marginX, marginY, textColor, border, imgSize, children, className }) => {
    return (
        <>
            <motion.div
