...
export const CardHeader = ({ whileHover, whileFocus, whileTap, initial, whileInView, transition, animate, whileDrag, img, color, textColor, width, height, padding, marginX, marginY, border, imgSize, children, className }) => {
    return (
        <>
            <motion.div
